<template>
  <div class="bottom-box">
    <div class="bj">
      ...
      <div class="text">
        {{ this.$originCopyWriting }} devotes itself to provide games for all ages. For example, you can find fierce types of games such as shooting and driving. Also, there are casual brain-burning games like puzzle and decryption games. Not only that, MMORPGs, strategy, or games that require long hours of operation also can be your options. Besides, we provide a series of unique online games for children. Parents, please trust us, that our website is very faith worthy, 100% safe, and child-friendly.
      </div>
    </div>
  </div>
</template>
