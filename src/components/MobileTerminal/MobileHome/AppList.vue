  ...
  <div>
    ...
    <div class="bottom">
      ...
      <div class="bottom-text">
        <div class="jXgCKW">
          Hi! Welcome to {{ this.$originCopyWriting.toUpperCase() }}.{{ this.$suffix }}!
          <br><br>
          ...
          You can play all our games on your mobile phone, tablet, pad without download or installation, just visit {{this.$originCopyWriting.toUpperCase()}}.{{ this.$suffix }} in your browser such as safari, chrome, firefox, etc, and then enjoy playing the games.
          <br><br>
          So, what are you waiting for? If you feel happy when playing our games, remember to bookmark {{this.$originCopyWriting.toUpperCase()}}.{{ this.$suffix }} and share it to your friends. Have fun!
        </div>
      </div>
    </div>
  </div>
