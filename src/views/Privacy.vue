<template>
  <div class="privacy_box">
    ...
    <div class="intro-text">
      ...
      <br/>
      <br/>
      We may share Personal Information about you with Demand and Supply Partners, with data enrichment sources, with our affiliates, with law enforcement and on a merger or an acquisition. WEBH5GAME will provide a prominent notice on the Site of any change in ownership or uses of this Personal Information if applicable. In any event, the entity which will assume the ownership of the Site will continue to protect Personal Information related to you under this Policy; Share it in any other circumstances where higooplay GAMES receives your written consent;<br/>
      <br/>
