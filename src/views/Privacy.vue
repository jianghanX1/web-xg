<template>
  <div class="privacy_box">
    <br/>
    <a href="index.html">
      <h3 class="menber">higooplay.com </h3>
    </a>
    <br/>
    ...
    <br/>
    <p>Copyright higooplay.com. All rights reserved.</p>
  </div>
</template>
